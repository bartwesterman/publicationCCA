...
%   Detailed explanation goes here
    ...
    nn = planB.SupportVectorMachine(); % added to make sure that the compiler knows to include the definition of RandomForest into this matlab executable, necessary to execute that task
