function exampleData = createDreamDExpectedData( dataSourceFilePath, dreamLethalityPath, dreamQualityTablePath, exampleDataFilePath )
    ...
    exampleData = data.DreamDrugDoseDExpectedData().init(obj.thesauri, dreamLethalityPath, dreamQualityTablePath);
